var w = this, d = w.document, a = "audio", v = "video", s = "script", PlatformDetector = function() {
    ...
    return t.prototype.setup = function() {
        ...
        this.audioElementEvents = {
            ...
            playing: function(t) {
                e.forcePause && !e.audioElement.paused && e.pause(void 0, !0), e.playstation && (e.audioTrackPlaying = !0), 
        ...
        t.open("HEAD", "//" + w.location.hostname + "/?rand=" + w.Math.floor(65536 * (1 + w.Math.random())), !1);
        try {
